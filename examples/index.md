...
---- | ---- | -----------
Aug 30 | [Point.zip](Point.zip) | Example class with JUnit test
Sep 7 | [FileIO.zip](FileIO.zip) | Examples of text file input/output
Sep 14 | [ExampleGUI.zip](ExampleGUI.zip) | Example MVC GUI
Nov 15 | [Change.zip](Change.zip) | Dynamic programming to make optimal change
